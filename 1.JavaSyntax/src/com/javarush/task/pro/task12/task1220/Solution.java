...
public class Solution {
    ...
    public static void checkElementsType(ArrayList<Object> elements) {
        ...
        for (int i = 0; i < elements.size(); i++) {
            if (elements.get(i) instanceof String) {printString();return;}
            if (elements.get(i) instanceof Integer) {printInteger();return;}
            if (elements.get(i) instanceof Integer[]) {printIntegerArray();return;}
            printUnknown();
